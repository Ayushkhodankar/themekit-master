...
if (isset($_GET['delete'])) {
    ...
    $dproductid = $_GET['car_id'];
    $sql = "delete from add_car where car_id='" . $dproductid . "'";
...
if (isset($_GET['delete1'])) {
    ...
    $dvenderid = $_GET['driver_id'];
    $sql = "delete from add_driver where driver_id='" . $dvenderid . "'";
                ...
                <div class="sidebar-content">
                    <div class="nav-container">
                        <nav id="main-menu-navigation" class="navigation-main">
                            ...
                            <div class="nav-item has-sub">
                                <a href="form-components.html"><i class="ik ik-box"></i><span>Add Car</span></a>
                            ...
                            <div class="nav-item has-sub">
                                <a href="#"><i class="ik ik-gitlab"></i><span>Car List</span> <span class="badge badge-success">New</span></a>
                                <!-- <div class="submenu-content">
                            ...
                            <div class="nav-item has-sub">
                                <a href="#"><i class="ik ik-package"></i><span>Rented Cars</span></a>
                                <!-- <div class="submenu-content">
                            ...
                            <div class="nav-item">
                                <a href="#"><i class="ik ik-credit-card"></i><span>Registered Users</span></a>
                            </div>
                            <div class="nav-item">
                                <a href="#"><i class="ik ik-inbox"></i><span>Reviews</span></a>
                            </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <form action="#">
                                                                    ...
                                                                    <input type="hidden" value="<?php echo $row['driver_id'] ?>" name="driver_id">
                                                                    <input type="submit" value="update" name="update">&nbsp;&nbsp;&nbsp;
