                ...
                <div class="sidebar-content">
                    <div class="nav-container">
                        <nav id="main-menu-navigation" class="navigation-main">
                            ...
                            <div class="nav-item has-sub">
                                <a href="pages/form-components.html"><i class="ik ik-box"></i><span>Add Car</span></a>
                            ...
                            <div class="nav-item has-sub">
                                <a href="pages/table-bootstrap.html"><i class="ik ik-gitlab"></i><span>Car List</span> <span class="badge badge-success">New</span></a>
                                <!-- <div class="submenu-content">
                            ...
                            <div class="nav-item has-sub">
                                <a href="pages/table-bootstrap.html"><i class="ik ik-package"></i><span>Rented Cars</span></a>
                                <!-- <div class="submenu-content">
                            ...
                            <div class="nav-item">
                                <a href="pages/table-bootstrap.html"><i class="ik ik-credit-card"></i><span>Registered Users</span></a>
                            </div>
                            <div class="nav-item">
                                <a href="pages/table-datatable.html"><i class="ik ik-inbox"></i><span>Reviews</span></a>
                            </div>
